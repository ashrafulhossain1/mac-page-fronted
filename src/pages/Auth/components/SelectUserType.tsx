      ...
      <div className="w-full space-y-4">
        ...
        >
          <img
            src={Line2}
            alt=""
            className="absolute top-0 right-[60%] w-[40%] pointer-events-none "
          />
          <span className="z-10 text-2xl md:text-3xl lg:text-[48px] font-bold text-gray-500">
            Guest
          </span>
          <img
            src={Line1}
            alt=""
            className="absolute bottom-1 left-[25%] w-[80%] pointer-events-none "
          />
        </Button>
        ...
        >
          <img
            src={line4}
            alt=""
            className="absolute top-0 right-[70%] w-[40%] pointer-events-none "
          />
          <span className="z-10 text-2xl md:text-3xl lg:text-[48px] font-bold text-white">
            Become a Host
          </span>
          <img
            src={line3}
            alt=""
            className="absolute bottom-1 left-[25%] top-0 w-[80%] pointer-events-none "
          />
        </Button>
      </div>
    </div>
