    ...
    <div className="flex flex-col items-center justify-center w-full py-7">
      ...
      <div className="w-full space-y-6">
        <Input
          ...
          className="w-full h-12 lg:h-[56px] rounded-[16px] bg-white border-gray-200 focus-visible:ring-primary pl-4 text-base  border text-secondary-foreground placeholder:text-secondary-foreground placeholder:text-sm md:placeholder:text-base lg:placeholder:text-lg"
        />
