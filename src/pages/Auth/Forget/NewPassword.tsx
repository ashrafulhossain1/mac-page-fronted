        ...
        <div className="flex flex-col items-center justify-center w-full py-7">
            ...
            <div className="w-full space-y-6">
                ...
                <div className="space-y-2">
                    <label className="text-sm md:text-base font-medium text-primary-foreground  mb-2.5">New Password</label>
                ...
                {/* Confirm Password */}
                <div className="space-y-2">
                    <label className="text-sm md:text-base font-medium text-primary-foreground ">Confirm Password</label>
                    <div className="relative mt-1 md:mt-2.5">
                        <Input
