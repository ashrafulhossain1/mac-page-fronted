...
export default function ContactUs() {
  ...
  return (
    <section
      id="contact-us"
      className="py-[120px] p-2 sm:px-4 md:px-6 bg-secondary overflow-hidden"
    >
      <div className="max-w-7xl mx-auto">
        <div className=" rounded-[16px] p-2 sm:px-4 md:px-8 ">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <motion.div
                variants={fastCardVariants}
                className="border border-gray-200 rounded-2xl p-6 space-y-5 bg-white shadow-sm"
              >
                {/* Full Name */}
                <div>
