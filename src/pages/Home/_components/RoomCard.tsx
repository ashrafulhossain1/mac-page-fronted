...
const RoomCard = ({ image, title, price, location, description, rating, reviews }: RoomCardProps) => {
    return (
        <Card className="max-w-[416px] overflow-hidden rounded-3xl p-4 group hover:shadow-xl transition-all duration-100 border">
            ...
            <CardHeader className="p-0 relative overflow-hidden">
                ...
                />
                <Badge
                    className="absolute top-4 right-4 bg-white text-black hover:bg-white rounded-full px-3 py-1 font-semibold text-xs shadow-sm"
                >
                    {price}
                </Badge>
            </CardHeader>
