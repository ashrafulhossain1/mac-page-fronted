    ...
    return (
        <div className="bg-[#EDEDED] p-6 sm:p-8 md:p-10 lg:p-12 rounded-[24px] flex flex-col sm:flex-row justify-between items-center gap-6 mb-10 overflow-hidden">
            <div className="text-center sm:text-left">
                <h1 className="text-2xl sm:text-[32px] font-semibold text-black mb-2 leading-tight">Welcome back, Smith!</h1>
                <p className="text-secondary-foreground font-medium text-base sm:text-lg">Here's what's happening with your listings today...</p>
            </div>
