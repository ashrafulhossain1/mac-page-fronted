...
export function ReviewCard({ rating, text, author, role, avatar }: ReviewCardProps) {
    return (
        <div className="bg-gray-100 rounded-xl shadow-md p-6 flex flex-col transition transform hover:-translate-y-2 hover:shadow-xl duration-300">
            {/* Stars */}
